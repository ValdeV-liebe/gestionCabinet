                    ...
                    <div class="welcome-wrapper shadow-reset res-mg-t mg-b-30">
                        ...
                        <div class="adminpro-message-list">
                            <ul class="message-list-menu">
                                <li><span class="message-serial message-cl-one">1</span> <span class="message-info">Please
                                        contact me</span> <span class="message-time">09:00
                                        pm</span>
                                </li>
                                <li><span class="message-serial message-cl-two">2</span> <span class="message-info">Sign
                                        a contract</span> <span class="message-time">10:00
                                        pm</span>
                                </li>
                                <li><span class="message-serial message-cl-three">3</span> <span class="message-info">Please
                                        delevary project</span> <span class="message-time">05:00 pm</span>
                                </li>
                                <li><span class="message-serial message-cl-four">4</span> <span class="message-info">Open
                                        new shop</span> <span class="message-time">04:00
                                        pm</span>
                                </li>
                                <li><span class="message-serial message-cl-five">5</span> <span
                                        class="message-info">Improtant Notification here</span> <span
                                        class="message-time">09:00 pm</span>
                                </li>
                                <li><span class="message-serial message-cl-five">5</span> <span
                                        class="message-info">Improtant Notification here</span> <span
                                        class="message-time">09:00 pm</span>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="project-dashone-phara">
                                    <p>Lorem Ipsum is simply dummy one text of the printing and the typesetting
                                        industry.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="sparkline11-graph dashone-comment comment-scrollbar">
                                    <div class="comment-phara">
                                        <div class="comment-adminpr">
                                            <p class="comment-content"><a href="#">@Toman Alva</a> Start each day
                                                with a prayer and end your day with a prayer and thank God for a
                                                another day.</p>
                                        </div>
                                    ...
                                    <div class="comment-phara">
                                        <div class="comment-adminpr">
                                            <p class="comment-content"><a href="#">@William Jon</a> Simple & easy
                                                online tools to increase the website visitors, improve SEO,
                                                marketing & sales, automatic blog!</p>
                                    ...
                                    <div class="comment-phara">
                                        <div class="comment-adminpr">
                                            <p class="comment-content"><a href="#">@mexicano</a> Soy cursi, twitteo
                                                frases pedorras y vendo antojitos mexicanos. Santa Rosa, La Pampa,
                                                Argentina</p>
                                        </div>
                                        <div class="admin-comment-month">
                                    ...
                                    <div class="comment-phara">
                                        <div class="comment-adminpr">
                                            <p class="comment-content"><a href="#">@Bhadkamkar</a> News love and
                                                follow Jesus and my family and friends l hope God bless you always.
                                            </p>
                                        </div>
                                        <div class="admin-comment-month">
                                    ...
                                    <div class="comment-phara">
                                        <div class="comment-adminpr">
                                            <p class="comment-content"><a href="#">@SHAKHAWAT</a> Make the Best Use
                                                of What You Have.You Never Know When & Where You Find Yourself..</p>
                                        </div>
                                        <div class="admin-comment-month">
                                    ...
                                    <div class="comment-phara comment-bd-phara">
                                        <div class="comment-adminpr">
                                            <p class="comment-content"><a href="#">@Sarah</a> A 'Power Chick'
                                                committed to using my superpowers for good. Author, speaker, radio
                                                host.</p>
                                        </div>
                                        <div class="admin-comment-month">
                        ...
                        <div class="sparkline-content timeline-scrollbar">
                                ...
                                <div class="col-lg-12">
                                    <div class="timeline-hd-main">
                                        <div class="timeline-heading-admin">
                                            ...
                                            <p><i class="fa fa-map-marker"></i> Meeting is on 6:00am. Check your
                                                schedule to see detail.</p>
                                        </div>
                            ...
                            <div class="row timelinewrap-admin res-mg-b-10">
                                ...
                                <div
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <p>Hope you all are doing good. We are one of manufacturer and supplier of
                                            Cow Crust and finished leather from USA. Please feel free to contact us
                                            if you have any queries.</p>
                                        <div class="admin-timeline-graph">
                                            <span data-diameter="40"
                                                class="updating-chart">2,5,9,6,5,9,7,3,5,2,5,3,9,6,5,8,7,8,5,2</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row timelinewrap-admin res-mg-b-10">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 timeline-adminpro-cn">
                                    <div class="timeline-content">
                                        ...
                                        <p>Yes, millennials are changing the way. This week on Radiate we're
                                            highlighting benefits and challenges of working across generator and
                                            cultures. Watch the newest Radiate Expert to join us.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row timelinewrap-admin res-mg-b-10">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 timeline-adminpro-cn">
                                    <div class="timeline-content">
                                        ...
                                        <p>Toys are watching you so is your car and your vacuum cleaner Here are 39
                                            ways your privacy is being compromised, and 8 guides to protecting your
                                            digital self.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row timelinewrap-admin res-mg-b-10">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 timeline-adminpro-cn">
                                    <div class="timeline-content">
                                        ...
                                        <p>The biggest Challenge which I have been use to Win is to in-house raw
                                            materials on time based on customer demand forecast and production
                                            capacity concentrating Seasonal impacts and considering foreign
                                            suppliers's cultural holidays, and Port congestion.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row timelinewrap-admin res-mg-b-10">
                            ...
                            <div class="row timelinewrap-admin">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 timeline-adminpro-cn">
                                    <div class="timeline-content">
                                        <h3>Meeting Fixed</h3>
                                        <p>My objective is to pursue a career leading company where I would gain
                                            experience while adding value to the business of the organization.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
